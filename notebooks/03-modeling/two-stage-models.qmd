...
if ("glmnet" %in% occ_models_to_run) {
  ...
  readr::write_csv(met_occ_glmnet, sprintf("../../outputs/models/tsr_tuning_metrics_occ_glmnet__%s.csv", sev_selection_metric))
...
if ("lgbm" %in% occ_models_to_run) {
  ...
  readr::write_csv(met_occ_lgbm, sprintf("../../outputs/models/tsr_tuning_metrics_occ_lgbm__%s.csv", sev_selection_metric))
...
if ("xgb" %in% occ_models_to_run) {
  ...
  readr::write_csv(met_occ_xgb, sprintf("../../outputs/models/tsr_tuning_metrics_occ_xgb__%s.csv", sev_selection_metric))
...
if (length(occ_val_results) > 0) {
  ...
  # Save results
  readr::write_csv(occ_summary, sprintf("../../outputs/models/tsr_stage1_occurrence_metrics__%s.csv", sev_selection_metric))
} else {
...
if (nrow(iso_curves) > 0) {
  readr::write_csv(iso_curves, sprintf("../../outputs/models/tsr_calibration_curves__%s.csv", sev_selection_metric))
}
...
readr::write_csv(calib_results, sprintf("../../outputs/models/tsr_stage1_calibration_results__%s.csv", sev_selection_metric))
...
arrow::write_parquet(
  ...
  sprintf("../../outputs/models/tsr_stage1_calibrated_predictions__%s.parquet", sev_selection_metric)
)
```
...
if ("glmnet_log" %in% sev_models_to_run) {
  ...
  readr::write_csv(met_sev_glmnet, sprintf("../../outputs/models/tsr_tuning_metrics_sev_glmnet_log__%s.csv", sev_selection_metric))
...
if ("lgbm_log" %in% sev_models_to_run) {
  ...
  readr::write_csv(met_sev_lgbm, sprintf("../../outputs/models/tsr_tuning_metrics_sev_lgbm_log__%s.csv", sev_selection_metric))
...
if ("xgb_log" %in% sev_models_to_run) {
  ...
  readr::write_csv(met_sev_xgb, sprintf("../../outputs/models/tsr_tuning_metrics_sev_xgb_log__%s.csv", sev_selection_metric))
...
if ("gamma_lgbm" %in% sev_models_to_run) {
  ...
  readr::write_csv(met_sev_gamma_lgbm, sprintf("../../outputs/models/tsr_tuning_metrics_sev_gamma_lgbm__%s.csv", sev_selection_metric))
...
if ("gamma_xgb" %in% sev_models_to_run) {
  ...
  readr::write_csv(met_sev_gamma_xgb, sprintf("../../outputs/models/tsr_tuning_metrics_sev_gamma_xgb__%s.csv", sev_selection_metric))
...
if (length(sev_val_results) > 0) {
  ...
  # Save results
  readr::write_csv(sev_summary, sprintf("../../outputs/models/tsr_stage2_severity_metrics__%s.csv", sev_selection_metric))
  ...
  arrow::write_parquet(
    ...
    sprintf("../../outputs/models/tsr_stage2_predictions_all_rows__%s.parquet", sev_selection_metric)
  )
} else {
...
# Save results
readr::write_csv(joint_summary, sprintf("../../outputs/models/tsr_joint_optimization_results__%s.csv", sev_selection_metric))
...
saveRDS(best_selection, sprintf("../../outputs/models/tsr_best_pipeline_selection__%s.rds", sev_selection_metric))
```
...
arrow::write_parquet(
  ...
  sprintf("../../outputs/models/two_stage_refined_test_predictions__%s.parquet", sev_selection_metric)
)

readr::write_csv(occ_tbl, sprintf("../../outputs/models/two_stage_refined_test_occ__%s.csv", sev_selection_metric))
readr::write_csv(sev_tbl, sprintf("../../outputs/models/two_stage_refined_test_sev__%s.csv", sev_selection_metric))
readr::write_csv(combined_tbl, sprintf("../../outputs/models/two_stage_refined_test_combined__%s.csv", sev_selection_metric))
...
saveRDS(final_selection_info, sprintf("../../outputs/models/two_stage_refined_selection__%s.rds", sev_selection_metric))
...
if (best_clf %in% c("lgbm", "xgb")) {
  ...
  arrow::write_parquet(
    occ_importance,
    sprintf("../../outputs/models/tsr_stage1_feature_importance__%s.parquet", sev_selection_metric)
  )
...
if (best_sev %in% c("lgbm_log", "xgb_log", "gamma_lgbm", "gamma_xgb")) {
  ...
  arrow::write_parquet(
    sev_importance,
    sprintf("../../outputs/models/tsr_stage2_feature_importance__%s.parquet", sev_selection_metric)
  )
...
readr::write_csv(naive_stage1_val_summary, "../../outputs/models/tsr_naive_stage1_validation.csv")
...
readr::write_csv(naive_stage2_val_summary, "../../outputs/models/tsr_naive_stage2_validation.csv")
...
readr::write_csv(naive_combined_test_summary, "../../outputs/models/tsr_naive_combined_test.csv")
